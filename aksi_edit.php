...
if(isset($_FILES['lampiran']) && $_FILES['lampiran']['error'] === UPLOAD_ERR_OK) {
    ...
    if(move_uploaded_file($lampiran_tmp_name, $lampiran_new_path)) {
        ...
        $sql = "UPDATE transaksi SET tanggal = '$tanggal', kategori_id = '$kategori_id', nominal = '$nominal', keterangan = '$keterangan', tanggal_input = '$tanggal_input', lampiran = '$lampiran_new_path' WHERE id = '$id'";
    ...
    $sql = "UPDATE transaksi SET tanggal = '$tanggal', kategori_id = '$kategori_id', nominal = '$nominal', keterangan = '$keterangan', tanggal_input = '$tanggal_input' WHERE id = '$id'";
    if ($koneksi->query($sql) === TRUE) {
        echo "<script>
                alert('Data berhasil diubah');
                window.location.href = 'tabel.php';
